...
#2. Зробив 3 файлі app.service.ts , limit.service.ts, file.service тому , що не знаю як краще викликати воркери . По часу всі працюют приблизно однаково. limit.service.ts використовуе пакет:
"p-limit": "^6.2.0",
